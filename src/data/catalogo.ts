...
const catalogoCompleto: Linha[] = [
  {
    ...
    produtos: [
      ...
      { slug: "caseirinho-lombo-legumes", emBreve: true, precoCentavos: 2090, nome: "Caseirinho de Lombo", subtitulo: "ao molho, legumes, arroz e feijão carioca", img: caseirinhoLombo, peso: "300g", descricao: "Copa lombo ao molho com cenoura, batata, arroz e feijão carioca, temperado com tomilho, louro e zaatar." },
      { slug: "caseirinho-soja-legumes", emBreve: true, precoCentavos: 1890, nome: "Caseirinho de Soja", subtitulo: "com legumes, arroz integral e feijão", img: caseirinhoSoja, peso: "300g", descricao: "Proteína de soja com batata, tomate e cenoura, acompanhada de arroz integral e feijão." },
      { slug: "caseirinho-frango-creme-de-milho", emBreve: false, precoCentavos: 2190, nome: "Caseirinho de Frango", subtitulo: "com creme de milho e arroz branco", img: caseirinhoCremeMilho, peso: "300g", descricao: "Peito de frango empanado com farinha de rosca zero glúten, creme de milho com leite zero lactose e arroz branco." },
      { slug: "caseirinho-sobrecoxa-batata-sautee", emBreve: false, precoCentavos: 2190, nome: "Caseirinho Sobrecoxa de Frango", subtitulo: "arroz, feijão e batata sautée", img: caseirinhoSobrecoxaSautee, peso: "300g", descricao: "Sobrecoxa de frango ao vinho branco com batata sautée, arroz e feijão." },
      { slug: "caseirinho-bovino-picadinho", emBreve: false, precoCentavos: 2290, nome: "Caseirinho Bovino", subtitulo: "picadinho de carne, arroz, feijão e farofa", img: caseirinhoBovinoPicadinho, peso: "300g", descricao: "Picadinho de patinho bovino com cenoura, batata e tomate, arroz, feijão e farofa de mandioca." },
      { slug: "caseirinho-macarrao-bolonhesa", emBreve: true, precoCentavos: 2290, nome: "Caseirinho de Macarrão", subtitulo: "sem glúten à bolonhesa", img: caseirinhoMacarraoBolonhesa, peso: "300g", descricao: "Macarrão sem glúten ao molho de tomate com carne bovina e manjericão fresco.", tags: ["Sem glúten"] },
      { slug: "caseirinho-carne-moida-legumes", emBreve: false, precoCentavos: 2290, nome: "Caseirinho de Carne Moída", subtitulo: "com legumes, arroz e feijão", img: caseirinhoCarneMoida, peso: "300g", descricao: "Acém bovino moído com batata, cenoura e tomate, acompanhado de arroz e feijão." },
      { slug: "caseirinho-saint-peter", emBreve: false, precoCentavos: 2490, nome: "Caseirinho Saint Peter", subtitulo: "arroz branco, feijão carioca e mix de legumes", img: caseirinhoSaintPeter, peso: "300g", descricao: "Filé de tilápia empanado com farinha de rosca zero glúten, arroz branco, feijão carioca, cenoura, vagem, couve-flor e brócolis." },
    ],
  },
  {
    slug: "aves",
    ...
    produtos: [
      ...
      { slug: "escondidinho-de-frango", emBreve: false, precoCentavos: 2090, nome: "Escondidinho de Frango", subtitulo: "com purê de batata doce", img: escondidinhoFrango, peso: "300g", kcal: 135, proteina: 14, descricao: "Frango desfiado ao molho com purê cremoso de batata doce.", tags: ["Sem glúten"] },
      { slug: "frango-ao-curry", emBreve: false, precoCentavos: 2290, nome: "Frango ao Curry", subtitulo: "com legumes", img: frangoCurry, peso: "300g", kcal: 55, proteina: 5, descricao: "Peito de frango ao curry suave com cenoura, brócolis e couve-flor.", tags: ["Sem glúten"] },
      { slug: "fricasse-de-frango", emBreve: false, precoCentavos: 2390, nome: "Fricassê de Frango", subtitulo: "com arroz fake de couve-flor", img: fricasseFrango, peso: "300g", kcal: 126, proteina: 16, descricao: "Fricassê cremoso com arroz fake de couve-flor. Baixo carb, alto sabor.", tags: ["Low carb"] },
      { slug: "estrogonofe-de-frango", emBreve: false, precoCentavos: 2390, nome: "Estrogonofe de Frango", subtitulo: "batata, arroz integral e brócolis", img: estrogonofeFrango, peso: "300g", descricao: "Estrogonofe cremoso com creme de leite zero lactose, batata, arroz integral e brócolis." },
      { slug: "galinhada-light", emBreve: false, precoCentavos: 2190, nome: "Galinhada Light", img: galinhadaLight, peso: "300g", kcal: 112, proteina: 11, descricao: "Coxa de frango desossada, arroz integral, cenoura, milho e ervilha com temperos brasileiros.", tags: ["Sem glúten"] },
  ...
  },
  {
    ...
    produtos: [
      ...
      { slug: "bolo-de-carne", emBreve: true, precoCentavos: 2590, nome: "Bolo de Carne", subtitulo: "na cama de legumes", img: boloCarne, peso: "300g", kcal: 117, proteina: 14, descricao: "Bolo de patinho com abobrinha, cenoura, brócolis e queijo zero lactose. Sem glúten.", tags: ["Sem glúten"] },
      { slug: "carne-desfiada-batata-doce", emBreve: false, precoCentavos: 2590, nome: "Carne Desfiada", subtitulo: "purê de batata doce e mix de legumes", img: carneDesfiada, peso: "300g", kcal: 99, proteina: 9.3, descricao: "Patinho desfiado com purê de batata doce e mix de legumes ao chimichurri.", tags: ["Sem glúten"] },
    ],
  },
  {
    slug: "massas",
  ...
  },
  {
    ...
    produtos: [
      ...
      { slug: "tilapia-em-crosta", emBreve: true, precoCentavos: 2890, nome: "Tilápia em Crosta", subtitulo: "linhaça e gergelim com arroz fake de couve-flor", img: tilapiaCrosta, peso: "300g", kcal: 138, proteina: 14, descricao: "Filé de tilápia em crosta de linhaça dourada e gergelim. Low carb.", tags: ["Low carb", "Sem glúten"] },
      ...
      { slug: "moqueca-de-cacao", emBreve: true, precoCentavos: 2690, nome: "Moqueca de Cação", subtitulo: "e arroz de açafrão", img: moquecaCacao, peso: "300g", kcal: 135, proteina: 16, descricao: "Moqueca cremosa com leite de coco, azeite de dendê e arroz de açafrão.", tags: ["Sem glúten"] },
  ...
  },
  {
    ...
    produtos: [
      ...
      { slug: "estrogonofe-grao-de-bico", emBreve: true, precoCentavos: 2390, nome: "Estrogonofe de Grão-de-Bico", subtitulo: "com arroz integral, brócolis e batata", img: estrogonofeGraoDeBico, peso: "300g", descricao: "Grão-de-bico ao molho de tomate com champignon e castanha de caju, arroz integral, brócolis e batata.", tags: ["Vegano"] },
  ...
  },
  {
    ...
    cor: "coral",
    produtos: [
      { slug: "brownie-fit", emBreve: true, precoCentavos: 1790, nome: "Brownie Fit", img: brownieFit, peso: "80g", kcal: 210, proteina: 7, descricao: "Brownie de cacau puro com chocolate 70%, farinha de aveia e óleo de coco.", tags: ["Sem açúcar"] },
      { slug: "brigadeiro-cremoso-fit", emBreve: true, precoCentavos: 1890, nome: "Brigadeiro Cremoso Fit", img: brigadeiroCremoso, peso: "80g", kcal: 162, proteina: 8, descricao: "Brigadeiro cremoso com leite zero lactose, cacau e eritritol.", tags: ["Sem açúcar", "Sem lactose"] },
      { slug: "beijinho-fit", emBreve: true, precoCentavos: 1890, nome: "Beijinho Fit", img: beijinhoFit, peso: "80g", kcal: 185, proteina: 7, descricao: "Beijinho cremoso com coco, óleo de coco e eritritol.", tags: ["Sem açúcar", "Sem lactose"] },
      { slug: "mousse-de-limao", emBreve: true, precoCentavos: 1890, nome: "Mousse de Limão", img: mousseLimao, peso: "80g", kcal: 33, descricao: "Mousse cremoso de limão taiti sem açúcar adicionado.", tags: ["Sem açúcar", "Sem lactose"] },
    ],
  },
  {
    slug: "pizzas",
  ...
  },
  {
    ...
    produtos: [
      ...
      { slug: "suco-desintox", emBreve: false, precoCentavos: 1790, nome: "Suco Desintox", img: sucoDesintox, peso: "300ml", kcal: 76, descricao: "Abacaxi, matcha, carqueja, mate verde, hortelã, gengibre, sálvia e alecrim.", tags: ["Detox"] },
      { slug: "suco-relax", emBreve: false, precoCentavos: 1790, nome: "Suco Relax", img: sucoRelax, peso: "300ml", kcal: 72, descricao: "Maracujá, anis, camomila, chia e melissa. Para acalmar." },
      { slug: "suco-imuno", emBreve: false, precoCentavos: 1790, nome: "Suco Imuno", img: sucoImuno, peso: "300ml", kcal: 80, descricao: "Morango, ora pro nobis, água de coco, limão, gengibre, canela e cúrcuma." },
      { slug: "suco-vitalmax", emBreve: false, precoCentavos: 1890, nome: "Suco Vitalmax", img: sucoVitalmax, peso: "300ml", kcal: 118, descricao: "Maçã, goiaba, beterraba, gengibre, pimenta de cheiro e caiena. Energia pura." },
