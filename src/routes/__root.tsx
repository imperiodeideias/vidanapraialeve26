import { CartProvider, CartLink, FloatingWhatsApp } from "@/components/Cart";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "icon", href: "/favicon.ico?v=vnpl", type: "image/x-icon" },
      { rel: "icon", href: "/favicon-vnpl.png", type: "image/png", sizes: "512x512" },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <CartProvider><Outlet /><CartLink /><FloatingWhatsApp /></CartProvider>
    </QueryClientProvider>
  );
}
