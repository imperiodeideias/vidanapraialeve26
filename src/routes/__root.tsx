...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Capriola&family=Chivo:wght@300;400;500;600&family=Poppins:wght@300;400;500;600;700&family=Great+Vibes&display=swap",
      },
    ],
    scripts: [
      {
